      ...
      000003 02 00 62         [24]  346 	ljmp	_main
                                    ...
                                    356 ;------------------------------------------------------------
                                    357 ;	blinkLed.c:2: void main(void)
                                    358 ;	-----------------------------------------
                                    359 ;	 function main
                                    360 ;	-----------------------------------------
      000062                        361 _main:
                           ...
                           000001   368 	ar1 = 0x01
                           000000   369 	ar0 = 0x00
                                    370 ;	blinkLed.c:4: while(1)
      000062                        371 00108$:
                                    372 ;	blinkLed.c:7: P1=0x00;
      000062 75 90 00         [24]  373 	mov	_P1,#0x00
                                    374 ;	blinkLed.c:9: while(i)
      000065 7E E8            [12]  375 	mov	r6,#0xe8
      000067 7F 03            [12]  376 	mov	r7,#0x03
      000069                        377 00101$:
      000069 EE               [12]  378 	mov	a,r6
      00006A 4F               [12]  379 	orl	a,r7
      00006B 60 07            [24]  380 	jz	00103$
                                    381 ;	blinkLed.c:11: i--;
      00006D 1E               [12]  382 	dec	r6
      00006E BE FF 01         [24]  383 	cjne	r6,#0xff,00134$
      000071 1F               [12]  384 	dec	r7
      000072                        385 00134$:
      000072 80 F5            [24]  386 	sjmp	00101$
      000074                        387 00103$:
                                    388 ;	blinkLed.c:13: P1=0x00;
      000074 75 90 00         [24]  389 	mov	_P1,#0x00
                                    390 ;	blinkLed.c:15: while(i)
      000077 7E E8            [12]  391 	mov	r6,#0xe8
      000079 7F 03            [12]  392 	mov	r7,#0x03
      00007B                        393 00104$:
      00007B EE               [12]  394 	mov	a,r6
      00007C 4F               [12]  395 	orl	a,r7
      00007D 60 E3            [24]  396 	jz	00108$
                                    397 ;	blinkLed.c:17: i--;
      00007F 1E               [12]  398 	dec	r6
      000080 BE FF 01         [24]  399 	cjne	r6,#0xff,00136$
      000083 1F               [12]  400 	dec	r7
      000084                        401 00136$:
                                    402 ;	blinkLed.c:20: }
      000084 80 F5            [24]  403 	sjmp	00104$
                                    404 	.area CSEG    (CODE)
                                    405 	.area CONST   (CODE)
                                    406 	.area XINIT   (CODE)
